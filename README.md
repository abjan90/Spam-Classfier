...
3. Custom Transformer: email_to_word_count
   The first transformer in the pipeline converts raw email objects into structured word count dictionaries. This component handles:
    ...
    a. Multipart MIME email parsing
    b. HTML-to-text conversion using BeautifulSoup
    c. Text normalization (lowercasing, URL replacement, number tokenization)
    d. Word stemming via NLTK Porter Stemmer
    e. Generation of Counter objects for efficient word frequency tracking
